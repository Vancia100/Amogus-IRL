...
socket.addEventListener("message", (message) => {
  ...
  case "updateTaskCounter":
    ...
    case "voteKicked":
      ...
      fetchSVG(svg =>{
        for (const playerName in messageJSON.voteList){
        ...
        setTimeout(() =>{
          ...
          document.querySelectorAll(".playerVote").forEach(element =>{
            element.remove()
          })
          emergencyBtn.classList.remove("invisible")
